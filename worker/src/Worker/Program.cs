...
namespace Worker
{
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            try
            {
                var pgsql = OpenDbConnection("Server=" + postgresHost + ";Port=" + postgresPort + ";Username=postgres;Password=postgres;");
                ...
                while (true)
                {
                    ...
                    if (json != null)
                    {
                        ...
                        if (!pgsql.State.Equals(System.Data.ConnectionState.Open))
                        {
                            ...
                            pgsql = OpenDbConnection("Server=" + postgresHost + ";Port=" + postgresPort + ";Username=postgres;Password=postgres;");
                        }
                        else
